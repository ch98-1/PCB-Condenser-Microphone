...
KiCad Library Files (All .lib .dcm and .pretty files in The PCB-Condenser-Microphone directory) are licensed under [KiCad Libraries License](http://kicad-pcb.org/libraries/license/).
